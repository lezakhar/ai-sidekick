...
def retrieve(
    ...
    Args:
        ...
        keywords: Ключевые слова для лексического поиска
            Пример: ("сантехник", "водопровод", "ремонт", "контакты", "мастер")
    Returns:
        str: Сформированный контекст из Базы знаний
    Note:
        LLM Необходимо самостоятельно отредактировать запрос пользователя и сформировать ключевые слова
        перед вызовом метода, для получения более релевантного ответа.
    """
